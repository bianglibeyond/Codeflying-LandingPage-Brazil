  ...
  socialProof: {
    ...
    cards: [
      ...
      },
      {
        ...
        region: "Global",
        kind: "Website",
        quote: "Course platform: 50,000+ active students on the website generated by CodeFlying.",
        metric: "50K users",
      },
      {
        flag: "🌐",
        region: "Global",
        kind: "Website",
        quote: "Membership community: 12,000+ paying subscribers managed through a website generated by CodeFlying.",
        metric: "12K subscribers",
      },
    ],
