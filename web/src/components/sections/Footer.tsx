...
const DISCORD_INVITE = "https://discord.gg/WcjX2pGw2M";
...
export function Footer() {
  return (
    <footer className="bg-dark-deeper text-white/80 mt-auto">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3 mt-2">
              <a
                ...
                aria-label="Discord"
                onClick={() =>
                  track("click_discord", { source_section: "footer" })
                }
      ...
      {/* Floating Discord button (mobile + desktop) */}
      <a
        href={DISCORD_INVITE}
        target="_blank"
        rel="noopener noreferrer"
        aria-label={copy.discord.navAriaLabelFloating}
        onClick={() =>
          track("click_discord", { source_section: "floating" })
        }
        className="fixed bottom-4 right-4 z-30 rounded-full bg-[#5865F2] p-3.5 shadow-lg text-white hover:scale-105 transition-transform"
